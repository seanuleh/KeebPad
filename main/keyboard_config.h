...
#define MODULE_ID "T-Display 32"
#define GATTS_TAG "KeebPad" // The device's name
...
#define ENCODER_A_PIN GPIO_NUM_22 // encoder phase A pin
#define ENCODER_B_PIN GPIO_NUM_21// encoder phase B pin
...
#define BATT_PIN ADC1_CHANNEL_6 //gpio pin 35, refer to the esp32 before modifying
